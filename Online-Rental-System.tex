...
hereon reffered to as ORS. In the system it should be possible for users to rent
out items to other users for a small fee and a safety deposit (in case of return
of damaged items). When a user wants to rent a provided item, the system should
provide the contact information to the providing user. The buisiness case is to
take a small amount when providing the contact information.

Users should be able to search for specific items or item catagories,
geografical locations, price ranges, etc. They should also be able to queue up
