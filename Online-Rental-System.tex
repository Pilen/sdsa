...
\section{Goals}
\label{sec:goals}
%Ask yourself questions like the following: What are the key targets that you
%are setting yourself as the architect? Do you aim to reuse existing software?
%Or develop the system at minimum cost? Or are you aiming for very high
%reliability? Or ... ?
...
\begin{description}
  ...
  \item[qosG3] The system shall keep personal information apart from the items. %TODO maybe explain
